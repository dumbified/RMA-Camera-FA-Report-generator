...
# Try to find the model file relative to this script
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
MODEL_PATH = os.path.join(SCRIPT_DIR, 'mobilevitv2.pth')
...
def run_rule_based_check(img_gray, num_segments=10):
    """
    Advanced histogram/threshold logic for classification
    """
